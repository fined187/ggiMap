...
import SearchAddress from '../bidForm/SearchAddress'
          ...
          <div className="flex flex-col w-[100%] gap-1">
            <div className="flex justify-between w-[100%]">
              {errors.agentName?.type == 'required' ? (
                ...
                biddingForm.agentName.length < 2 ? (
                <div className="flex w-[100%] justify-start">
                  <label
                    htmlFor="bidderName"
                    className="md:text-[20px] text-[16px] font-semibold font-['suit'] not-italic text-left leading-[135%] tracking-[-2%] text-red-500"
          ...
          <div className="flex flex-col w-[100%] gap-1">
            <div className="flex flex-row w-[100%]">
              ...
              biddingForm.agentRel === '' ? (
                ...
                biddingForm.agentRel.length > 10 ? (
                <div className="flex w-[100%] justify-start">
                  <label
                    htmlFor="agentRel"
                    className="md:text-[20px] text-[16px] font-semibold font-['suit'] not-italic text-left leading-[135%] tracking-[-2%] text-red-500"
              ...
              onChange={(e) => {
                ...
                setBiddingForm((prev: any) => {
                  return {
                    ...prev,
                    agentPhone:
                      prev.agentPhone1 + e.target.value + prev.agentPhone3,
                  }
                })
                handlePhoneFocusMove(e.target)
                handleInputChange(e)
              ...
              onChange={(e) => {
                ...
                setBiddingForm((prev: any) => {
                  return {
                    ...prev,
                    agentPhone:
                      prev.agentPhone1 + prev.agentPhone2 + e.target.value,
                  }
                })
                handlePhoneFocusMove(e.target)
                handleInputChange(e)
