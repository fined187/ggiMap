        ...
        <Marker
          ...
          icon={{
            content: `
                ...
                <mask id="path-1-inside-1_228_725" fill="white">
                ...
                <path d="M0 32H-1V33H0V32ZM35 32V33H36V32H35ZM35 0H36V-1H35V0ZM1 17.5C1 8.3873 8.3873 1 17.5 1V-1C7.28273 -1 -1 7.28273 -1 17.5H1ZM1 32V17.5H-1V32H1ZM17.5 31H0V33H17.5V31ZM35 31H17.5V33H35V31ZM34 0V32H36V0H34ZM17.5 1H35V-1H17.5V1Z" fill="#8F00FF" mask="url(#path-1-inside-1_228_725)"/>
                </svg>
